rules = [
    ...
    ''',
    '''More: <a href="https://deathnote.fandom.com/wiki/Rules_of_the_Death_Note/Manga_Chapter_Rules">🍎 Rules of the Death Note/Manga Chapter Rules 🖋</a>'''
]
max_page_rules = len(rules)